import{_ as n}from"./plugin-vue_export-helper.21dcd24c.js";import{o as s,c as a,e}from"./app.dd8982c9.js";const p={},t=e(`<h2 id="\u5F15\u5165\u4F9D\u8D56" tabindex="-1"><a class="header-anchor" href="#\u5F15\u5165\u4F9D\u8D56" aria-hidden="true">#</a> \u5F15\u5165\u4F9D\u8D56</h2><div class="language-xml ext-xml line-numbers-mode"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u6307\u5B9A\u5168\u5C40\u7684-serviceinterceptor" tabindex="-1"><a class="header-anchor" href="#\u6307\u5B9A\u5168\u5C40\u7684-serviceinterceptor" aria-hidden="true">#</a> \u6307\u5B9A\u5168\u5C40\u7684 ServiceInterceptor.</h3><p>\u4F60\u9700\u8981\u5B9E\u73B0 <code>GrpcServiceGlobalInterceptorConfigurer</code>\uFF0C \u5E76\u5C06\u5176\u58F0\u660E\u4E3A\u4E00\u4E2Abean\u5B9E\u4F8B</p><div class="language-java ext-java line-numbers-mode"><pre class="language-java"><code>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GreeterImplService</span> <span class="token keyword">extends</span> <span class="token class-name">GreeterGrpc<span class="token punctuation">.</span>GreeterImplBase</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u5982\u4F55\u8C03\u7528\u4E0A\u6587\u4E2D\u5B9A\u4E49\u7684grpc\u670D\u52A1-\u5BA2\u6237\u7AEF\u8C03\u7528" tabindex="-1"><a class="header-anchor" href="#\u5982\u4F55\u8C03\u7528\u4E0A\u6587\u4E2D\u5B9A\u4E49\u7684grpc\u670D\u52A1-\u5BA2\u6237\u7AEF\u8C03\u7528" aria-hidden="true">#</a> \u5982\u4F55\u8C03\u7528\u4E0A\u6587\u4E2D\u5B9A\u4E49\u7684GRPC\u670D\u52A1\uFF08\u5BA2\u6237\u7AEF\u8C03\u7528\uFF09</h3><h4 id="\u5B9A\u4E49\u58F0\u660E\u4E00\u4E2A\u8FDC\u7AEF\u7684\u670D\u52A1\u5668\u96C6\u7FA4" tabindex="-1"><a class="header-anchor" href="#\u5B9A\u4E49\u58F0\u660E\u4E00\u4E2A\u8FDC\u7AEF\u7684\u670D\u52A1\u5668\u96C6\u7FA4" aria-hidden="true">#</a> \u5B9A\u4E49\u58F0\u660E\u4E00\u4E2A\u8FDC\u7AEF\u7684\u670D\u52A1\u5668\u96C6\u7FA4</h4><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>
<span class="token comment"># \u542F\u52A8\u5BA2\u6237\u7AEF\u7684\u914D\u7F6E</span>
plus.jdk.grpc.client.enabled<span class="token operator">=</span>true

<span class="token comment"># \u6307\u5B9A\u4E00\u4E2A\u9ED8\u8BA4\u7684\u8FDE\u63A5\u5730\u5740, \u6307\u5B9A\u540E @GrpcClient \u6CE8\u89E3\u5C31\u9ED8\u8BA4\u4F7F\u7528\u8BE5\u503C</span>
plus.jdk.grpc.client.default-service<span class="token operator">=</span>MyGrpc://grpc-service-prod

<span class="token comment"># \u6307\u5B9A\u670D\u52A1\u7684scheme\u5730\u5740</span>
...
<span class="token comment"># \u6307\u5B9A\u670D\u52A1\u7684host\u5730\u5740</span>
...
<span class="token comment"># \u6307\u5B9A\u8FDC\u7AEF\u7684GRPC\u670D\u52A1\u5217\u8868</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="\u6307\u5B9A\u5168\u5C40\u7684grpcclientinterceptor" tabindex="-1"><a class="header-anchor" href="#\u6307\u5B9A\u5168\u5C40\u7684grpcclientinterceptor" aria-hidden="true">#</a> \u6307\u5B9A\u5168\u5C40\u7684<code>GrpcClientInterceptor</code></h4><p>\u540C\u4E0A\u95EE\uFF0C\u4F60\u9700\u8981\u5B9E\u73B0 <code>GrpcClientInterceptorConfigurer</code> \u65B9\u6CD5\uFF0C\u6DFB\u52A0\u5BF9\u5E94\u7684Interceptor</p><div class="language-java ext-java line-numbers-mode"><pre class="language-java"><code><span class="token keyword">import</span> <span class="token import"><span class="token namespace">org<span class="token punctuation">.</span>springframework<span class="token punctuation">.</span>stereotype<span class="token punctuation">.</span></span><span class="token class-name">Component</span></span><span class="token punctuation">;</span>
...
<span class="token comment">//        GreeterGrpc.GreeterBlockingStub blockingStub = grpcSubClientFactory.createStub(GreeterGrpc.GreeterBlockingStub.class, channel);</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,20),c=[t];function o(l,i){return s(),a("div",null,c)}var d=n(p,[["render",o],["__file","index.html.vue"]]);export{d as default};
